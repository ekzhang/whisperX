...
> **This is an experimental fork** that moves the alignment DP and post-processing into a Rust extension module for better performance and GIL release. Requires a Rust toolchain to build.
>
> ```
> pip install git+https://github.com/ekzhang/whisperX.git@rust-align
> ```
